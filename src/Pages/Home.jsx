      ...
      <div className='pt-24 w-full h-screen' style={{
        ...
        <Grid container spacing={2}>
         <Grid component={motion.div}
           ...
           <h1 className='flex justify-center w-full text-[40px] md:text-[70px] md:mt-[60px] text-red-600 font-bold'>SCRAP EXPRESS</h1>
           <h1 className='flex justify-center w-full text-[40px] md:text-[70px] text-red-600 font-bold'>BUYERS</h1>
