  ...
  return (
    <nav className='bg-[#22474d] fixed w-full z-20'>
      <div className='flex items-center justify-around font-medium'>
        ...
        <Link to="/service" className={`py-7 px-3 inline-block hover:text-green-400 focus:text-[#FF0000] ${
          defaultPath === '/service' ? 'text-[#FF0000]' : ''
        }`}>Our Service</Link>
            ...
            <Link to="/contact" className={`py-7 px-3 inline-block hover:text-green-400 focus:text-[#FF0000] ${
          defaultPath === '/contact' ? 'text-[#FF0000]' : ''
        }`}>Contact</Link>
          </li>
          {/* <NavbarLink/> */}
          <li>
        ...
        <ul className={`md:hidden fixed h-full w-full bg-gray-300 bottom-0 py-0 pl-4 duration-500 top-[76px] ${open ? "left-0":"left-[-100%]"}`}>
         ...
         <Link to="/service" className={`py-3 px-3 inline-block hover:text-green-400 focus:text-[#FF0000] ${
          defaultPath === '/service' ? 'text-[#FF0000]' : ''
         ...
         <Link to="/contact" className={`py-3 px-3 inline-block hover:text-green-400 focus:text-[#FF0000] ${
          defaultPath === '/contact' ? 'text-[#FF0000]' : ''
